...
namespace ProjetoMusical {
    ...
    public partial class Database1DataSet3 : global::System.Data.DataSet {
        ...
        public partial class FuncionariosDataTable : global::System.Data.TypedTableBase<FuncionariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public FuncionariosRow AddFuncionariosRow(string Nome, string Senha) {
...
namespace ProjetoMusical.Database1DataSet3TableAdapters {
    ...
    public partial class FuncionariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Funcionarios] WHERE (([Nome] = @Original_Nome) AND ([Senha] = " +
                "@Original_Senha))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Funcionarios] ([Nome], [Senha]) VALUES (@Nome, @Senha);\r\nSELEC" +
                "T Nome, Senha FROM Funcionarios WHERE (Nome = @Nome)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Funcionarios] SET [Nome] = @Nome, [Senha] = @Senha WHERE (([Nome] =" +
                " @Original_Nome) AND ([Senha] = @Original_Senha));\r\nSELECT Nome, Senha FROM Func" +
                "ionarios WHERE (Nome = @Nome)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Nome, Senha FROM dbo.Funcionarios";
        ...
        public virtual int Fill(Database1DataSet3.FuncionariosDataTable dataTable) {
        ...
        public virtual Database1DataSet3.FuncionariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet3.FuncionariosDataTable dataTable = new Database1DataSet3.FuncionariosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet3.FuncionariosDataTable dataTable) {
